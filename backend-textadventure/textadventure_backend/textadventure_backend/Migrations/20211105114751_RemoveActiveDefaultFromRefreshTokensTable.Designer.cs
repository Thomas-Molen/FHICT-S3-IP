...
namespace textadventure_backend.Migrations
{
    ...
    [Migration("20211105114751_RemoveActiveDefaultFromRefreshTokensTable")]
    partial class RemoveActiveDefaultFromRefreshTokensTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("textadventure_backend.Models.AdventurerMaps", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("textadventure_backend.Models.Adventurers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("textadventure_backend.Models.Dungeons", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("textadventure_backend.Models.Interactions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("textadventure_backend.Models.Items", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("textadventure_backend.Models.NPCs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("textadventure_backend.Models.RefreshTokens", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("textadventure_backend.Models.Rooms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("textadventure_backend.Models.Users", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("textadventure_backend.Models.Weapons", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("textadventure_backend.Models.AdventurerMaps", b =>
                {
                    b.HasOne("textadventure_backend.Models.Adventurers", "Adventurer")
            ...
            modelBuilder.Entity("textadventure_backend.Models.Adventurers", b =>
                {
                    b.HasOne("textadventure_backend.Models.Dungeons", "Dungeon")
            ...
            modelBuilder.Entity("textadventure_backend.Models.Interactions", b =>
                {
                    b.HasOne("textadventure_backend.Models.NPCs", "NPC")
            ...
            modelBuilder.Entity("textadventure_backend.Models.NPCs", b =>
                {
                    b.HasOne("textadventure_backend.Models.Items", "Item")
                        .WithMany("NPCs")
                        .HasForeignKey("ItemId")
                        .HasConstraintName("FK_NPCs_Items")
                        .IsRequired();

                    b.HasOne("textadventure_backend.Models.Weapons", "Weapon")
                        .WithMany("NPCs")
            ...
            modelBuilder.Entity("textadventure_backend.Models.Rooms", b =>
                {
                    ...
                    b.HasOne("textadventure_backend.Models.Interactions", "EastInteraction")
                        .WithMany("RoomEast")
                        .HasForeignKey("EastInteractionId")
                        .HasConstraintName("FK_Rooms_EastInteractions")
                        .IsRequired();

                    b.HasOne("textadventure_backend.Models.Interactions", "NorthInteraction")
                        .WithMany("RoomNorth")
                        .HasForeignKey("NorthInteractionId")
                        .HasConstraintName("FK_Rooms_NorthInteractions")
                        .IsRequired();

                    b.HasOne("textadventure_backend.Models.Interactions", "SouthInteraction")
                        .WithMany("RoomSouth")
                        .HasForeignKey("SouthInteractionId")
                        .HasConstraintName("FK_Rooms_SouthInteractions")
                        .IsRequired();

                    b.HasOne("textadventure_backend.Models.Interactions", "WestInteraction")
                        .WithMany("RoomWest")
